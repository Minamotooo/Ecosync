...
import Cascade from "F:/ECOSYNC/Ecosync/Frontend/src/assets/Deforestation_Defender.jpg";
    ...
    <CardContainer className="inter-var">
      <CardBody
        ...
        <CardItem translateZ={100} className="w-full mt-2 relative">
          ...
          <p className="text-white text-center text-lg" style={{ textShadow: '2px 2px 4px rgba(0, 0, 0, 0.8)' }}>A tower-defense game protecting various forest types from deforestation and fires, highlighting biodiversity and carbon storage</p>
          </div>
        </CardItem>
